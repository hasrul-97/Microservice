...
namespace DMSManager.Entities
{
    ...
    {
        public File(string folderID, string name, DateTime createdOn, string fileType, string createdBy, DateTime lastModifiedOn, string lastModifiedBy, string parent, string physicalLocation, string version, string size)
        {
            Id = folderID;
            Name = name;
            CreatedOn = createdOn;
